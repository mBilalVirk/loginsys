...
@section('content')
    ...
    <hr>
    <div class="row">
        <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#viewUsers{{ $users->count() }}" style="cursor:pointer;">
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>
                                            <img src="{{ asset($user->photo) }}" width="60" height="60"
                                        ...
                                        <td>
                                            <form action="{{ route('admin.permanentDeleteUser', $user->id) }}"
                                                method="POST"
        ...
        <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#viewPost" style="cursor:pointer;">
                            ...
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.restorePost', $post->id) }}" method="POST"
                                        ...
                                        <td>
                                            <form action="{{ route('admin.permanentDeletePost', $post->id) }}"
                                                method="POST"
                                                onsubmit="return confirm('Are you sure you want to delete this post?');">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#viewComments{{ $comments->count() }}"
                            ...
                            <tbody>
                                @foreach ($comments as $comment)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.restoreComment', $comment->id) }}"
                                                method="POST"
                                        ...
                                        <td>
                                            <form action="{{ route('admin.permanentDeleteComment', $comment->id) }}"
                                                method="POST"
        ...
        <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#viewAdmin{{ $admins->count() }}"
            style="cursor:pointer;">
                            ...
                            <tbody>
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td>{{ $admin->email }}</td>
                                        <td>
                                            <img src="{{ asset($admin->photo) }}" width="60" height="60"
                                                class="rounded-circle object-fit-cover">
                                        </td>

                                        <td>
                                            <form action="{{ route('admin.restoreAdmin', $admin->id) }}" method="POST"
                                                onsubmit="return confirm('Are you sure you want to restore this user?');">
                                                @csrf
                                                @method('POST')
                                                <button type="submit" class="btn btn-success">Restore</button>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.permanentDeleteAdmin', $admin->id) }}"
                                                method="POST"
                                                onsubmit="return confirm('Are you sure you want to delete this post?');">
        ...
        <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#viewFriends{{ $friends->count() }}"
            style="cursor:pointer;">
                            ...
                            <tbody>
                                @foreach ($friends as $friend)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.restoreFriend', $friend->id) }}" method="POST"
                                        ...
                                        <td>
                                            <form action="{{ route('admin.permanentDeleteFriend', $friend->id) }}"
                                                method="POST"
