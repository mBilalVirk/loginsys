    ...
    <div class="search-bar" style="width:500px">
        <div
            ...
            <form action="{{ route('search.user') }}" method="GET"
                ...
                <input type="search" value="{{ request('searchUser') }}" name="searchUser" placeholder="Search friends..."
                    style=" padding: 8px;" />
                ...
                <div class="friends-list">
                    @foreach ($users as $user)
                        <div class="friend-card">
                            <img src="{{ $user->photo ? asset('/' . $user->photo) : asset('images/default-user.png') }}"
