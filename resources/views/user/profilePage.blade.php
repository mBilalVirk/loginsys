...
<body>
    ...
    <nav id="navbar">
        ...
        <div class="nav-right">
            <ul id="navbar-items">
                <li class="navbar-item no-mob"><a class="navbar-item-inner" href=""><span><i
                                class='uil uil-home-alt'></i> Home</span></a></li>
                <li class="navbar-item no-mob"><a class="navbar-item-inner" href=""><span><i
                                class='uil uil-comment-image'></i> Forum</span></a></li>
                <li class="navbar-item no-mob"><a class="navbar-item-inner" href=""><span><i
                                class="uil uil-shopping-bag"></i> Store</span></a></li>
                <li class="navbar-item"><a class="navbar-item-inner" href=""><span><i
                                class='uil uil-user'></i></span></a></li>
            </ul>
        </div>
    </nav>
    <div id="menu">
        ...
        <div class="menu-left">
            <h3>General</h3>
            <ul class="menu-items">
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i class='uil uil-home-alt'></i>
                            Home</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i
                                class='uil uil-comment-image'></i> Forum</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i
                                class="uil uil-shopping-bag"></i> Store</span></a></li>
            </ul>
        ...
        <div class="menu-center">
            <h3>Useful Links</h3>
            <ul class="menu-items">
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i class="uil uil-bookmark"></i>
                            Tutorials</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i
                                class="uil uil-map-marker-info"></i> Dynmap</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i class='uil uil-server-alt'></i>
                            Servers</span></a></li>
            </ul>
        </div>
        <div class="menu-right">
            <h3>Admin Tools</h3>
            <ul class="menu-items">
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i class="uil uil-lightbulb"></i>
                            Control Panel</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i
                                class="uil uil-brackets-curly"></i> Code Editor</span></a></li>
                <li class="menu-item"><a class="menu-item-inner" href=""><span><i class="uil uil-window"></i>
                            Info & Status</span></a></li>
            </ul>
        </div>
    ...
    <div class="back-to-top" style="display: block; opacity: 1;">
        <a class="semplice-event" href="#" data-event-type="helper" data-event="scrollToTop" style="opacity: 1;">
            <svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="53px" height="20px"
                viewBox="0 0 53 20" enable-background="new 0 0 53 20" xml:space="preserve">
                <g id="Ebene_3"></g>
                <g>
        ...
        <div class="user-info-bar">
            ...
            <div class="ufo-bar-col4">
                <div class="ufo-bar-col4-inner">
                    <button class="button2 btn-primary2"><i class="uil uil-plus"></i> Subscribe<div
                            class="btn-secondary2"></div></button>
                </div>
            </div>
    ...
    <footer id="footer" class="flexbox-col">
        <div class="footer-logo-wrapper flexbox">
            <svg class="footer-logo" xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2"
                viewBox="0 0 805.93 1044.03">
                <defs>
                    <style>
                        .cls-4 {
                            fill: none;
                ...
                <polyline class="cls-4"
                    points="518.08 328.59 783.43 177.13 783.43 39 401.75 258.32 22.5 39 22.5 183.8 588.35 507.92 510.81 553.96 783.43 706.63 783.43 839.92 402.97 621.82 22.5 839.92 22.5 707.85 386 497.02" />
                <text class="cls-5" transform="translate(187.07 1022.89)">X<tspan class="cls-5" x="74.41" y="0">
                        CRAFT</tspan></text>
            </svg>
        </div>
        <div class="footer-inner flexbox">
            <div class="footer-left">
                <svg class="footer-ico" xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2"
                    viewBox="0 0 805.93 878.75">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: none;
            ...
            <div class="footer-right">
                <div class="footer-links">
                    <a class="footer-link fl-first" href="https://www.youtube.com/channel/UCfstx-8p0M5K1KTBUB4ORLQ"
                        target="_blank">YouTube.</a>
                    <a class="footer-link" href="https://twitter.com/xcraftserver" target="_blank">Twitter.</a>
                    <a class="footer-link" href="https://www.instagram.com/xcraftofficial/"
                        target="_blank">Instagram.</a>
                    <a class="footer-link fl-last" href="https://discordapp.com/invite/G7yJ2Ww"
